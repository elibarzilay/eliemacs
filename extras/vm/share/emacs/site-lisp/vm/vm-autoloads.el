...
;;;;;;  u-vm-color-summary-mode) "u-vm-color" "u-vm-color.el" (18705
;;;;;;  64595))
...
;;;;;;  vm-recover-folder) "vm" "vm.el" (18705 64595))
...
\(fn &optional FOLDER READ-ONLY ACCESS-METHOD)" t nil)
...
;;;;;;  "vm-avirtual" "vm-avirtual.el" (18705 64595))
...
;;;;;;  "vm-crypto" "vm-crypto.el" (18705 64595))
...
;;;***

;;;### (autoloads (vm-expunge-folder vm-delete-duplicate-messages
;;;;;;  vm-kill-subject vm-undelete-message vm-delete-message-backward
;;;;;;  vm-delete-message) "vm-delete" "vm-delete.el" (18705 64595))
...
;;;;;;  "vm-digest" "vm-digest.el" (18705 64595))
...
;;;;;;  vm-edit-message) "vm-edit" "vm-edit.el" (18705 64595))
...
;;;;;;  vm-spool-move-mail vm-help vm-recover-file vm-revert-buffer
...
;;;;;;  vm-unread-message) "vm-folder" "vm-folder.el" (18705 64595))
...
;;;;;;  "vm-grepmail" "vm-grepmail.el" (18705 64595))
...
;;;***

;;;### (autoloads (vm-rename-imap-folder vm-delete-imap-folder vm-create-imap-folder
;;;;;;  vm-read-imap-folder-name vm-imap-parse-spec-to-list vm-imap-make-filename-for-spec
;;;;;;  vm-imap-find-spec-for-buffer vm-imap-folder-check-for-mail
;;;;;;  vm-imap-synchronize-folder vm-imap-save-message vm-imap-end-session
;;;;;;  vm-imap-make-session vm-imap-move-mail) "vm-imap" "vm-imap.el"
;;;;;;  (18705 64595))
...
\(fn &optional INTERACTIVE DO-REMOTE-EXPUNGES DO-LOCAL-EXPUNGES DO-RETRIEVES DO-ATTRIBUTES)" nil nil)

(autoload 'vm-imap-folder-check-for-mail "vm-imap" "\
Not documented
...
\(fn PROMPT SPEC-LIST &optional SELECTABLE-ONLY NEWONE)" nil nil)
...
;;;;;;  "vm-license" "vm-license.el" (18705 64595))
...
;;;;;;  vm-clear-all-marks) "vm-mark" "vm-mark.el" (18705 64595))
...
;;;;;;  "vm-message-history.el" (18705 64595))
...
;;;***

;;;### (autoloads (vm-mime-encode-composition vm-mime-encode-words-in-string
...
;;;;;;  vm-mime-reader-map-pipe-to-command vm-mime-reader-map-save-message
;;;;;;  vm-mime-reader-map-save-file vm-mime-run-display-function-at-point
;;;;;;  vm-decode-mime-message) "vm-mime" "vm-mime.el" (19121 62859))
...
;;;***

;;;### (autoloads (vm-previous-message-same-subject vm-next-message-same-subject
;;;;;;  vm-previous-unread-message vm-next-unread-message vm-previous-message-no-skip
;;;;;;  vm-next-message-no-skip vm-previous-message vm-next-message
;;;;;;  vm-goto-parent-message vm-goto-message-last-seen vm-goto-message)
;;;;;;  "vm-motion" "vm-motion.el" (18705 64595))
...
;;;;;;  "vm-page" "vm-page.el" (18705 64595))
...
;;;;;;  "vm-pcrisis" "vm-pcrisis.el" (18705 64595))
...
;;;;;;  vm-postponed-folder vm-summary-function-p vm-postponed-attribute
;;;;;;  vm-postponed-header vm-summary-function-f) "vm-pine" "vm-pine.el"
;;;;;;  (18705 64595))
...
(defvar vm-postponed-attribute "P" "\
Summary string that will be inserted by `vm-summary-function-p' for
postponed messages.")

(custom-autoload 'vm-postponed-attribute "vm-pine" t)
...
(autoload 'vm-pop-folder-check-for-mail "vm-pop" "\
Not documented
...
;;;;;;  "vm-ps-print" "vm-ps-print.el" (18705 64595))
...
;;;;;;  vm-do-reply) "vm-reply" "vm-reply.el" (18705 64595))
...
;;;;;;  vm-delete-quit vm-summary-function-A vm-summary-function-S
...
;;;;;;  vm-mail-check-recipients vm-mime-save-all-attachments vm-mime-delete-all-attachments
;;;;;;  vm-mime-auto-save-all-attachments-delete-external vm-mime-auto-save-all-attachments
;;;;;;  vm-mime-attach-files-in-directory vm-mime-all-attachments-directory
;;;;;;  vm-mime-display-button-message/external-body vm-switch-to-folder
;;;;;;  vm-fill-paragraphs-containing-long-lines-by-longlines vm-fill-paragraphs-containing-long-lines-faster
;;;;;;  vm-unfill-paragraphs-containing-long-lines-faster vm-fill-paragraphs-containing-long-lines-toggle
;;;;;;  vm-fill-long-lines-in-reply vm-do-fcc-before-mime-encode
;;;;;;  vm-followup-include-presentation vm-reply-include-presentation
;;;;;;  vm-rfaddons-infect-vm) "vm-rfaddons" "vm-rfaddons.el" (18705
;;;;;;  64595))
...
(autoload 'vm-fill-long-lines-in-reply "vm-rfaddons" "\
Not documented

\(fn)" t nil)

(autoload 'vm-fill-paragraphs-containing-long-lines-toggle "vm-rfaddons" "\
Not documented
...
(autoload 'vm-fill-paragraphs-containing-long-lines-faster "vm-rfaddons" "\
Not documented

\(fn WIDTH START END)" nil nil)
...
(defvar vm-mime-all-attachments-directory nil "\
*Directory to where the attachments should go or come from.")

(custom-autoload 'vm-mime-all-attachments-directory "vm-rfaddons" t)
...
(autoload 'vm-mime-delete-all-attachments "vm-rfaddons" "\
Not documented
...
;;;;;;  vm-match-data) "vm-save" "vm-save.el" (18705 64595))
;;; Generated autoloads from vm-save.el

(autoload 'vm-match-data "vm-save" "\
Not documented
...
;;;***

;;;### (autoloads (vm-isearch-backward vm-isearch-forward) "vm-search"
;;;;;;  "vm-search.el" (18705 64595))
...
;;;;;;  vm-move-message-forward) "vm-sort" "vm-sort.el" (18705 64595))
...
;;;***

;;;### (autoloads (vm-fix-my-summary!!! vm-summarize-other-frame
;;;;;;  vm-summarize) "vm-summary" "vm-summary.el" (19121 63043))
...
;;;;;;  "vm-summary-faces" "vm-summary-faces.el" (18705 64595))
...
;;;;;;  "vm-thread" "vm-thread.el" (18705 64595))
...
(autoload 'vm-th-thread-indentation "vm-thread" "\
Not documented

\(fn M)" nil nil)

(autoload 'vm-th-thread-list "vm-thread" "\
Not documented
...
;;;;;;  "vm-toolbar" "vm-toolbar.el" (18705 64595))
...
;;;;;;  "vm-undo" "vm-undo.el" (18705 64595))
...
;;;;;;  "vm-virtual" "vm-virtual.el" (18705 64595))
...
;;;;;;  "vm-menu.el" "vm-message.el" "vm-minibuf.el" "vm-misc.el"
;;;;;;  "vm-pgg.el" "vm-revno.el" "vm-serial.el" "vm-startup.el"
;;;;;;  "vm-user.el" "vm-vars.el" "vm-version.el") (19121 63125 446935))
...
(setq vm-configure-datadir "/home/eli/EliEmacs/extras/vm/share")
(setq vm-configure-pixmapdir "/home/eli/EliEmacs/extras/vm/share/vm")
