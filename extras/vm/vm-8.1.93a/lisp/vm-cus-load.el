...
(put 'vm 'custom-loads '(u-vm-color vm-vars vm-avirtual vm-biff vm-rfaddons vm-grepmail vm-message-history vm-mime vm-pgg vm-pine vm-ps-print vm-serial vm-toolbar vm-w3m vm-pcrisis))
