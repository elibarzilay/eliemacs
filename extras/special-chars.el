...
`post-command-hook'; used to implement the single input method."
  (unless (memq this-command '(eli-input-method/single
    ...
    (remove-hook 'post-command-hook 'input-method/single-inactivate)
    (when eli-input-buffer
      (with-current-buffer eli-input-buffer (deactivate-input-method)))
    (setq eli-input-buffer nil)))
...
(defun set-input-method/single (method)
  ...
  (if current-input-method
    ...
    (progn (set-input-method method)
           ;; remember the buffer, so if we switch to a different buffer
           ;; it still disables a sequence in the original one
           (setq eli-input-buffer (current-buffer))
           (add-hook 'post-command-hook 'input-method/single-inactivate))))
...
(defun isearch-toggle-eli-input-method/single ()
  ...
  (interactive)
  (if current-input-method
    (let ((this-command nil)) (deactivate-input-method))
    (let ((default-input-method "eli"))
      (isearch-toggle-input-method)
      (progn (setq eli-input-buffer (current-buffer)) ; same as above
             (add-hook 'post-command-hook 'input-method/single-inactivate)))))
...
;; convenient mnemonics
    ...
    ("`"      #x2018)
    ("'"      #x2019)
    ("<"      [#x2329 #x2039 #x276c #x276e #x2770])
    (">"      [#x232a #x203a #x276d #x276f #x2771])
    ("<<"     #x00AB)
    (">>"     #x00BB)
    ("<|"     [#x25C0 #x25C1 #x25C2 #x25C3 #x25C4 #x25C5 #x23F4 #x2BC7])
    ("|>"     [#x25B6 #x25B7 #x25B8 #x25B9 #x25BA #x25BB #x23F5 #x2BC8])
    ("["      #x3014)
    ("]"      #x3015)
    ("[["     #x27E6)
    ("]]"     #x27E7)
    ...
    ("^2" #x00B2) ("sup2" #x00B2) ("_2" #x2082) ("sub2" #x2082)
    ("^3" #x00B3) ("sup3" #x00B3) ("_3" #x2083) ("sub3" #x2083)
    ("^4" #x2074) ("sup4" #x2074) ("_4" #x2084) ("sub4" #x2084)
    ("^5" #x2075) ("sup5" #x2075) ("_5" #x2085) ("sub5" #x2085)
    ("^6" #x2076) ("sup6" #x2076) ("_6" #x2086) ("sub6" #x2086)
    ("^7" #x2077) ("sup7" #x2077) ("_7" #x2087) ("sub7" #x2087)
    ("^8" #x2078) ("sup8" #x2078) ("_8" #x2088) ("sub8" #x2088)
    ("^9" #x2079) ("sup9" #x2079) ("_9" #x2089) ("sub9" #x2089)
    ("^+" #x207A) ("sup+" #x207A) ("_+" #x208A) ("sub+" #x208A)
    ("^-" #x207B) ("sup-" #x207B) ("_-" #x208B) ("sub-" #x208B)
    ("^=" #x207C) ("sup=" #x207C) ("_=" #x208C) ("sub=" #x208C)
    ("^(" #x207D) ("sup(" #x207D) ("_(" #x208D) ("sub(" #x208D)
    ("^)" #x207E) ("sup)" #x207E) ("_)" #x208E) ("sub)" #x208E)
    ("^a" #x1D43) ("supa" #x1D43) ("_a" #x2090) ("suba" #x2090)
    ("^b" #x1D47) ("supb" #x1D47)
    ("^c" #x1D9C) ("supc" #x1D9C)
    ("^d" #x1D48) ("supd" #x1D48)
    ("^e" #x1D49) ("supe" #x1D49) ("_e" #x2091) ("sube" #x2091)
    ("^f" #x1DA0) ("supf" #x1DA0)
    ("^g" #x1D4D) ("supg" #x1D4D)
    ("^h" #x02B0) ("suph" #x02B0) ("_h" #x2095) ("subh" #x2095)
    ("^i" #x2071) ("supi" #x2071) ("_i" #x1D62) ("subi" #x1D62)
    ("^j" #x02B2) ("supj" #x02B2) ("_j" #x2C7C) ("subj" #x2C7C)
    ("^k" #x1D4F) ("supk" #x1D4F) ("_k" #x2096) ("subk" #x2096)
    ("^l" #x02E1) ("supl" #x02E1) ("_l" #x2097) ("subl" #x2097)
    ("^m" #x1D50) ("supm" #x1D50) ("_m" #x2098) ("subm" #x2098)
    ("^n" #x207f) ("supn" #x207f) ("_n" #x2099) ("subn" #x2099)
    ("^o" #x1D52) ("supo" #x1D52) ("_o" #x2092) ("subo" #x2092)
    ("^p" #x1D56) ("supp" #x1D56) ("_p" #x209A) ("subp" #x209A)
    ;; (no q)
    ("^r" #x02B3) ("supr" #x02B3) ("_r" #x1D63) ("subr" #x1D63)
    ("^s" #x02E2) ("sups" #x02E2) ("_s" #x209B) ("subs" #x209B)
    ("^t" #x1D57) ("supt" #x1D57) ("_t" #x209C) ("subt" #x209C)
    ("^u" #x1D58) ("supu" #x1D58) ("_u" #x1D64) ("subu" #x1D64)
    ("^v" #x1D5B) ("supv" #x1D5B) ("_v" #x1D65) ("subv" #x1D65)
    ("^w" #x02B7) ("supw" #x02B7)
    ("^x" #x02E3) ("supx" #x02E3) ("_x" #x2093) ("subx" #x2093)
    ("^y" #x02B8) ("supy" #x02B8)
    ("^z" #x1DBB) ("supz" #x1DBB)
    ("0/3"    #x2189)
    ("1/"     #x215F)
    ...
    ("#check" #x2714) ("check" #x2713)
    ("#ballot" #x2718) ("ballot" #x2717)
    ("#v"     #x2714) ("v" #x2713)                   ; easier to
    ("#x"     [#x2718 #x2716]) ("x" [#x2717 #x2715]) ; remember
    ("#*"     #x2731)
    ("#+"     #x271A)
    ;; "," -> turned
    (",?"     #x00BF)
